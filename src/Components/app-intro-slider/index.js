...
const wp=require('react-native-responsive-screen');
...
class AppIntroSlider extends React.Component {
  ...
  render() {
    ...
    return (
      <react_native_1.ImageBackground source={require('../../Assets/Images/Polygon-6.png')} style={styles.flexOne}>
...
const ratio=win.width/1125;
const styles = react_native_1.StyleSheet.create({
  flexOne: {
    flex: 1,
     width:react_native_1.Dimensions.get('window').width,
     height:wp.heightPercentageToDP('45%'),
    color:'#86888F',
  },
  flatList: {
    flex: 1,
  ...
  paginationDots: {
    height: 16,
    marginLeft:wp.widthPercentageToDP('3.5%') ,
    flexDirection: isAndroidRTL ? 'row-reverse' : 'row',
