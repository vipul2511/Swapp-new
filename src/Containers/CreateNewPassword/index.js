...
import {View, Text,SafeAreaView, TouchableOpacity,KeyboardAvoidingView,ScrollView, Image} from 'react-native';
  ...
  return (
    <SafeAreaView style={Styles.container}>
      ...
      <View style={{marginHorizontal: wp('5%')}}>
       ...
       <Button handleFunction={()=>navigation.navigate('CreateNewPasscode')} btnText={'Create'}/>
