    ...
    <KeyboardAvoidingView
      ...
      <View style={{marginHorizontal: wp('8%')}}>
        <View style={{marginVertical: hp('3%')}}>
          <Text style={{fontSize: wp('5.5%'), fontWeight: '600',fontFamily:'Poppins-SemiBold', color: 'white'}}>
            Enter your password
          </Text>
        </View>
        ...
        <CustomInput
          ...
          warning={warning}
          noBorder
          style={{color:warning ?'#FF0B80':'#fff',fontFamily:'Inter-Bold'}}
        />
        ...
        {/* <TextInput placeholder={'dffd'}/> */}
          ...
          {!warning ? (
           <Button handleFunction={(text)=>Setdata(text)} btnText={'Log in'}/>
            ...
            // />
            <Button style={true} handleFunction={(text)=>Setdata(text)} btnText={'Log in'}/>
          )}
    </KeyboardAvoidingView>
    </SafeAreaView>
  );
