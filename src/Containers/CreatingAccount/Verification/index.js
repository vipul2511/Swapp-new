...
const Verification = (props) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {
                props.auth.loader ? <ActivityIndicator style={{flex: 1}} size="large" color="#246BFD"/> :
                        ...
                        <View style={styles.inputBlock}>
                            <CodeField
                                ...
                                renderCell={({index, symbol, isFocused}) => (
                                    <View
                                        key={index}
                                        style={[styles.cell, {borderColor: props.auth.codeError ? '#FF0B80' : '#5E6272'}, isFocused && styles.focusCell]}
